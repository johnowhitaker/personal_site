---
title: "RE of a DVD Drive"
date: 2026-05-05
categories: 
  - "misc"
image: "images/drive_switch.png"
...
![Artist's depiction of this technique, lol](images/drive_code_cave.png)
...
![Physical setup, with wires soldered to front panel connector and a way to physically power-cycle the drive](images/drive_switch.png)
...
When faced with this block, there are a few tricks you can try:
...
Anyway, I hope you found this interesting. If you want to read more on how the code works, or try it yourself, I've dumped ~everything on github - start [here](https://github.com/johnowhitaker/bmelt/blob/codex/clean-slate/minimal/README.md). As mentioned, I'm hoping this is only the start and that at some point I'll get proper control and make the hardware do some tricks... Hopefully see you in a future post soon :)
